...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-10">
        ...
        ['id'=>'category_id','class'=>'form-control selectpicker','data-live-search'=>'true', 'required'])}}
...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-10">
        {{Form::number('price',$product->price,['id'=>'price','class'=>'form-control', 'min'=>0, 'required' ])}}
    </div>
</div>
<div class="form-group row mb-2">
    <label class="col-sm-2 col-form-label" for="discount">{{ trans('common.discount') }}</label>
    <div class="col-sm-10">
        {{Form::number('discount',$product->discount,['id'=>'discount','class'=>'form-control', 'min'=>0, 'required'])}}
    </div>
</div>
<div class="form-group row mb-2">
    <label class="col-sm-2 col-form-label" for="quantity">{{ trans('common.quantity') }}</label>
    <div class="col-sm-10">
        {{Form::number('quantity',$product->quantity,['id'=>'quantity','class'=>'form-control', 'min'=>0, 'required' ])}}
    </div>
</div>
...
<div class="form-group row mb-2">
  ...
  <div class="col-sm-10">
    ...
    ],$product->active,['id'=>'active','class'=>'form-control', 'required' ])}}
...
<div class="form-group row mb-2">
  ...
  <div class="col-sm-10">
    {{Form::select('show_on_it',[
      ...
      'offer' =>  trans('common.discount')
    ],$product->show_on_it,['id'=>'show_on_it','class'=>'form-control', 'required' ])}}
  </div>
</div>
