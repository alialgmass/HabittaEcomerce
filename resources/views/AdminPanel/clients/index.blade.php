                        ...
                        <tbody  class="text-center">
                            ...
                            <tr id="row_{{$user->id}}">
                                ...
                                <td>
                                    ...
                                    @endif
                                    <?php $delete = route('admin.clientUsers.delete',['id'=>$user->id]); ?>
                                    <button type="button" class="btn btn-icon btn-danger" onclick="confirmDelete('{{$delete}}','{{$user->id}}')">
...
@section('page_buttons')
    <a href="{{route('admin.clientUsers.create')}}" class="btn btn-primary">
