    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                {{Form::open(['url'=>route('roles.update',$role->id), 'id'=>'editRoleForm'.$role->id,
                'class'=>'row gy-1 pt-75'])}}
                <div class="col-12 col-md-6">
                    <label class="form-label" for="name_ar">{{trans('common.name_ar')}}</label>
                    {{Form::text('name_ar',$role->name,['id'=>'name_ar', 'class'=>'form-control'])}}
                </div>
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-bolder">
                                            ...
                                            <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="{{trans('common.Allows a full access to the system')}}">
                                        ...
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="selectAll"> {{trans('common.Select
                                                    All')}} </label>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check me-3 me-lg-1">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="{{$permission['id']}}" @if($permission['hasIt']==1)
                                                        checked @endif />
