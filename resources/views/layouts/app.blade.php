...
<head>
    ...
    <title>{{isset($title) ? $title : 'Furnigoz'}}</title>
    ...
    <!-- BEGIN: Page CSS--><link rel="stylesheet" type="text/css" href="{{asset('AdminAssets/app-assets/css/pages/app-ecommerce.css')}}">
...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a class="ms-25" href="https://1.envato.market/pixinvent_portfolio" target="_blank">AliAlgmass</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-end d-none d-md-block">Hand-crafted & Made with<i data-feather="heart"></i></span></p>
</footer>
...
<script src="{{asset('AdminAssets/app-assets/vendors/js/extensions/wNumb.min.js')}}"></script>
<script src="{{asset('AdminAssets/app-assets/vendors/js/extensions/nouislider.min.js')}}"></script>
<script src="{{asset('AdminAssets/app-assets/vendors/js/extensions/toastr.min.js')}}"></script>
<!-- END: Page JS-->
...
<script src="{{asset('AdminAssets/app-assets/vendors/js/extensions/sweetalert2.all.min.js')}}"></script>
<script src="{{asset('AdminAssets/app-assets/js/scripts/pages/app-ecommerce.js')}}"></script>
@yield('scripts')
